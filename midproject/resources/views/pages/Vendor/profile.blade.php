...
<div class="mb-3">
  ...
  <input type="text" class="form-control input" type="text" name="name" id="exampleFormControlInput1"
...
<div class="mb-3">
  ...
  <input type="email" class="form-control input" id="exampleFormControlInput1" name="email" value="{{$UserProfile->email}}" placeholder="name@example.com">
</div>
@error('email')
<div class="alert alert-danger" role="alert">
  {{$message}}
...
<div class="mb-3">
  ...
  <input type="number" class="form-control input" id="exampleFormControlInput1" name="phone"  value="{{$UserProfile->phone}}" placeholder="01*********">
</div>
@error('phone')
<div class="alert alert-danger" role="alert">
  {{$message}}
...
<div class="mb-3">
  ...
  <input type="text" class="form-control input" id="exampleFormControlInput1" name="nid"  value="{{$UserProfile->nid}}" placeholder="420*********">
</div>
@error('nid')
<div class="alert alert-danger" role="alert">
  {{$message}}
...
<div class="mb-3">
  ...
  <input type="address" class="form-control input" id="exampleFormControlInput1" name="address" value="{{$UserProfile->address}}"  placeholder="house, road, sub-district, district">
</div>
@error('address')
<div class="alert alert-danger" role="alert">
  {{$message}}
...
<div class="mb-3">
  ...
  <input type="password" class="form-control input" id="exampleFormControlInput1" name="password"  value="{{$UserProfile->password}}" placeholder="*********">
</div>
@error('password')
<div class="alert alert-danger" role="alert">
  {{$message}}
